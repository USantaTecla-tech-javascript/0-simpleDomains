...
msg = msg +( coins50 > 0 ? coins50 + COINS_OF + 50 + "\n" : "");
msg = msg + (coins20 > 0 ? coins20 + COINS_OF + 20 + "\n" : "");
msg = msg + (coins10 > 0 ? coins10 + COINS_OF + 10 + "\n" : "");
msg = msg + (coins5 > 0 ? coins5  + COINS_OF + 5 + "\n" : "");
msg = msg + (coins2 > 0 ? coins2 + COINS_OF + 2 + "\n" : "");
msg = msg + (remainder1 > 0 ? remainder1 + COINS_OF + 1 : "");
console.log(msg);
