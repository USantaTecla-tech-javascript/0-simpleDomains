...
const msgType = equilateral !== "" ? equilateral : isosceles;
msgType = scalene !== "" ? scalene : msgType;
console.writeln(`Los lados ${sideA}, ${sideB} y ${sideC}${total - greater > greater ? "" : " NO"} forman un triangulo ${isTriangle ? `de tipo ${msgType}` : ""}`);
